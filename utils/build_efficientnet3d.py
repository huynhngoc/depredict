...
#     "b1": ("069f0534ff22adf035c89e3D9547a9dc",
#            "0e80663031ca33D657f9caa404b6ec37"),
...
#            "af0682fb74e8c54910f3D4393339c070"),
#     "-m": ("a3bf6aa3276309f4fc6a34aa114c95cd",
#            "1b8dc055df73Dde80d614482840fe342"),
...
def MBConvBlock(
    ...
    def apply(inputs):
        ...
        if expand_ratio != 1:
            ...
            x = layers.Activation(
                activation, name=name + "expand_activation")(x)
        else:
            x = inputs
...
def EfficientNetV2(
    ...
    Args:
      ...
      pooling: optional pooling mode for feature extraction when `include_top` is
        ...
        thus the output of the model will be a 3D tensor. - `"max"` means that
